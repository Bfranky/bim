...
const shots: GItem[] = [
  { label: 'Suya on the Grill',       tall: true, img: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=900&q=80',  thumb: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400&q=65' },
  { label: 'Peppered Chicken',                    img: 'https://images.unsplash.com/photo-1598103442097-8b74394b95c7?w=700&q=80',  thumb: 'https://images.unsplash.com/photo-1598103442097-8b74394b95c7?w=350&q=65' },
  { label: 'Grilled Fish',                        img: 'https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?w=700&q=80',  thumb: 'https://images.unsplash.com/photo-1580822184713-fc5400e7fe10?w=350&q=65' },
  { label: 'Pork Chops',              tall: true, img: 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=900&q=80',  thumb: 'https://images.unsplash.com/photo-1432139555190-58524dae6a55?w=400&q=65' },
  { label: 'Pepper Soup Bowl',                    img: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=700&q=80',  thumb: 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=350&q=65' },
  { label: 'Chicken Wings',                       img: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=700&q=80',  thumb: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=350&q=65' },
];
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gridAutoRows: '220px', gap: 12 }}>
            {shots.map((s, i) => (
              <div key={i}
                ...
                <img src={s.thumb} alt={s.label} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block', transition: 'transform 0.55s ease, filter 0.4s ease', transform: hovered === i ? 'scale(1.1)' : 'scale(1)', filter: hovered === i ? 'brightness(0.4)' : 'brightness(0.8)' }} />
      ...
      {lightbox !== null && (
        <div onClick={close} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.95)', zIndex: 3000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, backdropFilter: 'blur(8px)', animation: 'lbIn 0.3s ease' }}>
          <div onClick={(e) => e.stopPropagation()} style={{ position: 'relative', maxWidth: 860, width: '100%', background: '#1a1a1a', borderRadius: 6, overflow: 'hidden', border: '1px solid rgba(255,69,0,0.3)', animation: 'lbUp 0.35s ease' }}>
            <img src={shots[lightbox].img} alt={shots[lightbox].label} style={{ width: '100%', maxHeight: '70vh', objectFit: 'cover', display: 'block' }} />
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 8, paddingBottom: 20 }}>
              {shots.map((_, i) => <button key={i} onClick={() => setLightbox(i)} style={{ width: i === lightbox ? 24 : 8, height: 8, borderRadius: 4, border: 'none', cursor: 'pointer', background: i === lightbox ? 'var(--fire)' : 'rgba(255,69,0,0.25)', transition: 'all 0.3s' }} />)}
            </div>
